...
namespace KassemCars
{
    ...
    {
        public static SqlConnection con = new SqlConnection(@"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=|DataDirectory|KassemCarsDb.mdf;Integrated Security=True;Connect Timeout=30;MultipleActiveResultSets=true");
